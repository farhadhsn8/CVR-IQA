...
class DataLoader(object):
    ...
    def __init__(self, dataset, path, ref_path, img_indx, patch_size, patch_num, batch_size=32, istrain=True, self_patch_num=10, use_HQref = True ,  mode = "all" , type="Overall", repeatable_loss = False):
        ...
        if dataset == 'live':
            ...
            self.data = folders.Kadid10kFolder(
                root=path, HQ_diff_content_root=ref_path, index=img_indx, transform=transforms, HQ_diff_content_transform=HQ_diff_content_transform, patch_num=patch_num, patch_size = patch_size, self_patch_num=self_patch_num, repeatable_loss= self.repeatable_loss)
            ...
            self.data = folders.PIQ23Folder(
                root=path, HQ_diff_content_root=ref_path, index=img_indx, transform=transforms, HQ_diff_content_transform=HQ_diff_content_transform, patch_num=patch_num, patch_size = patch_size, self_patch_num=self_patch_num, mode = mode , type=type)
