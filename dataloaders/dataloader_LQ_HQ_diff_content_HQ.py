...
class DataLoader(object):
    ...
    def __init__(self, dataset, path, ref_path, img_indx, patch_size, patch_num, batch_size=32, istrain=True, self_patch_num=10, use_HQref = True ,  mode = "all" , type="Overall"):
